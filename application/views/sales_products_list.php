                                ...
                                <div class="ps-product__content"><a class="ps-product__title product_title_new" href="<?= $base_url ?>index.php/main/product/<?= $cat_p['id'] ?>">
                                    ...
                                    <?php if ($cat_p['total_count_in_store'] > 0) : ?>
                                        ...
                                        <p class="ps-product__price sale prods_slider">
                                                <button onclick='addToCart(res = <?= json_encode($cat_p) ?>)' class="btn-cart_cat-none" style="height: 36px; font-weight: bold; color: #ef5d70; border: none; border-radius: 5px; width: 85%;">Нет в наличии</button>
                                        </p>
                                        <?php endif; ?>
                                </div>
                            </div>
