    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <div style="display: flex; padding: 0 10px;">
          <a href="<?= base_url("admin/users");?>" class="btn btn-primary" style="display: flex; margin: 0 10px;">
            Пользователь
          </a>
          <a href="<?= base_url("admin/employees");?>" class="btn btn-primary active" style="display: flex; margin: 0 10px;">
            Сотрудник
          </a>
          <a href="<?= base_url("admin/administrators");?>" class="btn btn-primary" style="display: flex; margin: 0 10px;">
            Администратор
          </a>
        </div>
        ...
        <div class="box-body">
          ...
          <table id="TableUser" class="table table-bordered table-hover">
            ...
            <tbody id="#" draggable="false">
              ...
              <tr>
                  <td>{user_id}</a></td>
                  <td style="text-align: center;width: 100px;"><img src="<?= base_url() ?>user_img/{image}" style="width: 50px;" /></a></td>
                  <td>{name}</td>
                  <td>{login}</td>
                  <td>{access_type}</td>
