    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <div style="display: flex; padding: 0 10px;">
          ...
          <a href="<?= base_url("admin/employees");?>" class="btn btn-primary" style="display: flex; margin: 0 10px;">
            Сотрудник
          </a>
          <a href="<?= base_url("admin/administrators");?>" class="btn btn-primary active" style="display: flex; margin: 0 10px;">
            Администратор
          </a>
        </div>
